...
const MantenimientoCuentasBancos = () => {
  ...
  return (
    <div className="space-y-4">
      ...
      <Image
        src="https://miconcar.com/uploads/documentos/concar_cb_C4_8_menu_mantenimiento_cuentas_bancos_.jpg"
      ...
      <div>
        ...
        Nota: Para los bancos de Crédito y Continental, registrar en nombre de
        Banco.
      </div>
    </div>
  );
