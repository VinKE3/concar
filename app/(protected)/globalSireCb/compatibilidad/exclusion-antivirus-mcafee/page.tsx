  ...
  const data = [
    {
      id: 1,
      title:
        "como realizar la exclusión a los sistemas de real systems en el antivirus mcafee",
      href: "https://miconcar.com/uploads/documentos/1088_Cod.1088_D01075_c%C3%B3mo_realizar_la_exclusi%C3%B3n_a_los_sistemas_de_real_systems_en_el_antivirus_mcafee.pdf",
    },
  ];
  return (
