  ...
  const data = [
    {
      id: 1,
      title:
        "cómo_proceder_cuando_se_presenta_mensaje_de_inconsistencia_al_generar_un_reporte_en_excel_en_el_ambiente_del_concarcb	",
      href: "https://miconcar-uploads.s3.amazonaws.com/documentos/2023/11/1093_Cod.1093_D01080_como_proceder_cuando_se_presenta_mensaje_de_inconsistencia_al_generar_un_reporte_en_excel_en_el_ambiente_del_concarcb1.pdf",
    },
  ];
  return (
    <div className="space-y-3">
      <p>
        Al momento de trabajar en el ambiente del CONCAR CB y emitir algun
