  ...
  const data = [
    {
      id: 1,
      title:
        "omo realizar la exclusión de los sistemas de real systems en el antivirus avast",
      href: "https://miconcar.com/uploads/documentos/1086_1086_Cod.1086_D01073_c%C3%B3mo_realizar_la_exclusi%C3%B3n_de_los_sistemas_de_real_systems_en_el_antivirus_avast.pdf",
    },
  ];
  return (
