...
const page = () => {
  const data = [
    {
      id: 1,
      title: "como_configurar_igv8_en_ventas_concasql_ley31556",
      href: "https://miconcar.com/uploads/documentos/1177_1177_Cod.1177_D01164_como_configurar_igv8_ventas_concarsql.doc1.pdf",
    },
  ];
  return (
    <div className="space-y-3">
      ...
      <h1>¿Cómo registrar una factura de venta con IGV 10% en CONCAR SQL?</h1>
      ...
      <h1>
        Proceso de Actualización al Concar SQL versión 14.03 hacia adelante
      </h1>
      <div className="px-6 md:w-[45rem] h-96 lg:h-100%  mr-auto mb-10">
        <div
          style={{
