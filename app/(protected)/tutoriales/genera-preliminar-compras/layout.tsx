...
export default function Layout({ children }: LayoutProps) {
  ...
  const flattenedData = generaCompra.reduce((acc: any, item) => {
    return [...acc, item];
  }, []);
  ...
  return (
    <Container>
      <Header
        ...
        href="/tutoriales/genera-preliminar-compras-main"
        subtitle="Categoría: CONCAR® SIRE CB"
        text="Funcionalidad Generación Registro de Compras"
      />
      <TriButtons
        indice="/tutoriales/genera-preliminar-compras-main"
        anterior={anterior}
